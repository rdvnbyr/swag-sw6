...
class AmazonPayRoute extends AbstractAmazonPayRoute
{
    ...
    {
        try {
            $this->logger->debug('/store-api/amazon-pay-pure-payment line '.__LINE__);
        ...
        $this->logger->debug('/store-api/amazon-pay-pure-payment response '.__LINE__, $responseData->all());
        $response = new AmazonPayRouteResponse($responseData);
