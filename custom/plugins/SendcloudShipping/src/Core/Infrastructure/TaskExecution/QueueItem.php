...
class QueueItem
{
    ...
    /**
     * @var int $lastExecutionProgressBasePoints in base points (integer value of 0.01%)
     */
    private $lastExecutionProgressBasePoints;

    /**
     * @var int $progressBasePoints in base points (integer value of 0.01%)
     */
     ...
     *
     * @param string $status Queue item status. One of QueueItem::CREATED, QueueItem::QUEUED, QueueItem::IN_PROGRESS,
    ...
    public function getTask()
    {
        if (empty($this->task)) {
            ...
            if (empty($this->task)) {
                throw new QueueItemDeserializationException(json_encode(array(
     ...
     *
     * @param string $failureDescription Queue item failure description
     */
     ...
     *
     * @param int $createTimestamp Sets queue item created timestamp
     */
     ...
     *
     * @param int $startTimestamp Queue item start timestamp
     */
     ...
     *
     * @param int $finishTimestamp Queue item finish timestamp
     */
     ...
     *
     * @param int $failTimestamp Queue item fail timestamp
     */
     ...
     *
     * @param int $earliestStartTimestamp Queue item earliest start timestamp
     */
     ...
     *
     * @param int $queueTimestamp Queue item queue timestamp
     */
     ...
     *
     * @param int $lastUpdateTimestamp Queue item last updated timestamp
     */
    ...
    /**
     * Subscribes task event listeners
     *
     * @return void
     */
